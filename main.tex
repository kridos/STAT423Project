...
This study examines how various song and artist characteristics influence ratings of Billboard Hot 100 Number One songs across decades. 
Data from the 1960s through the 2010s were divided into decade-specific subsets. Before stepwise selection using AIC, the main effects model and model including interaction terms were compared.
Comparing the optimized models across decades revealed that the predictors of song ratings vary over time, with no single factor remaining consistently significant across all decades.
\end{abstract}
...
Our interest in music inspired our group to investigate how musical preferences change over time. 
Across generations, different characteristics of songs and artists may influence how highly a song is rated.
By comparing these predictors across time periods, this study highlights how trends and artist characteristics, such as race, may influence song ratings.
...
\noindent Therefore, it is reasonable to treat the response as continuous for linear regression, and no transformation of the response was required. 
