...
We chose the model that best explained the variability in overall ratings in its decade while still being penalized on complexity (best adjusted $R^2$ value).
