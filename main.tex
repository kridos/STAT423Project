...
First we looked at the numeric predictors: energy, danceability, happiness, loudness\_db, bpm, length\_sec, and age.
...
\noindent Let $Y$ denote the overall rating of the song. The predictors are:
...
\begin{subfigure}
    \centering
    \includegraphics[width=0.7\linewidth]{Scatterplots for Numeric Predictors.png}
    \caption*{Figure 1: Scatterplot Matrix for Numeric Predictors}
\end{subfigure}

\noindent In Figure 1, the numeric predictors reveal several moderate correlations among audio characteristics. 
...
\noindent These observations suggest that some audio characteristics may capture similar musical attributes and thus, potential multicollinearity when performing linear regression.
...
\begin{subfigure}
    ...
    \caption*{Figure 2: Boxplots of Categorical Predictors}
\end{subfigure}

\noindent The boxplots show that song ratings are relatively similar across race and gender groups. 
...
\begin{subfigure}
    ...
    \caption*{Figure 3: Historgram of Song Ratings}
\end{subfigure}
...
\begin{subfigure}
    ...
    \caption*{Figure 4: Coefficient Esimates Over Time by Genre}
\end{subfigure}

\noindent Although the coefficient estimates suggest that genre is not a consistently significant predictor of ratings, 
...
\textbf{Explain how you selected your variables (e.g., stepwise selection, theoretical justification, handling of multicollinearity). If you used transformations (like taking the log of the response), explain why.}
