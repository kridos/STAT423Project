...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{scatterplots_numeric.png}
...
\noindent The 1960s model was selected as the proposed model because it retained a meaningful set of predictors and demonstrated reasonable predictive power relative to the other decade models. 
...
\noindent Among the predictors, song length shows a positive relationship with rating, suggesting that longer songs tend to receive slightly higher ratings on average. 
\noindent Some genre effects also appear, with the coefficient for the “Other” genre indicating a modest difference relative to the baseline genre. 
...
\noindent such as race or gender. Overall, these coefficients indicate that both song and artist characteristics contribute to variation in song ratings.
