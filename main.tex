...
\maketitle
\begin{abstract}
\noindent Music has been a key part of daily life, but peoples' opinions of music has always been everchanging. 
\noindent With factors, such as race, having a different impact on society during each decade, this study focuses
\noindent how different factors affect song ratings during different decades. Data from billboard top 100 songs were
...
\noindent was optimized based on its AIC to determine which predictors made a significant impact on the model. These predictors and their predicative
\noindent power was compared to other models - finding out that energy, race, and some other predictors were quite prevelant in most 
\noindent decades, but no singular factor was consistent between every decade. Ultimately, the findings demonstrated that 
